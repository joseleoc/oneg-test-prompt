...
export const StorySchema = yup.object().shape({
  ...
  userName: yup
    .string()
    .required("El nombre de quien crea la historia es obligatorio")
    .typeError("El nombre de quien crea la historia es obligatorio"),
  language: yup
    .string()
    .required("El idioma es obligatorio")
    .oneOf(Object.values(Language), "Selecciona una opción")
    .default(Language.ES),
  age: yup
    .number()
  ...
  length: yup
    ...
    .max(20, "La longitud debe ser menor o igual a 20")
    .typeError("La longitud debe ser un número"),
  focus: yup
    .string()
    .required()
    .oneOf(Object.values(Focus), "Selecciona una opción"),
  focusDescription: yup
    ...
    .when("focus", {
      ...
      then: (schema) =>
        schema.required(
          "La descripción del foco es obligatoria cuando el foco es OTHER"
        ),
  ...
  core: yup
    .string()
    .required()
    .oneOf(Object.values(StoryCore), "Selecciona una opción"),
  scenario: yup
    .string()
    .required()
    .oneOf(Object.values(StoryScenario), "Selecciona una opción"),
  ...
  purpose: yup
    .string()
    .required()
    .oneOf(Object.values(GeneralPurpose), "Selecciona una opción"),
  ...
  character: yup
    .string()
    .required()
    .oneOf(Object.values(MainCharacter), "Selecciona una opción"),
